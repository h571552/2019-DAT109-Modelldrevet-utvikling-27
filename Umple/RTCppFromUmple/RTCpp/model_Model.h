...
#pragma include_alias(".\\ExpoEAO.h", "/ExpoEAO.h")
#pragma include_alias(".\\InstituteEAO.h", "/InstituteEAO.h")
#pragma include_alias(".\\StandEAO.h", "/StandEAO.h")
#pragma include_alias(".\\StudyEAO.h", "/StudyEAO.h")
#pragma include_alias(".\\VisitorEAO.h", "/VisitorEAO.h")
#pragma include_alias(".\\VoteEAO.h", "/VoteEAO.h")
#pragma include_alias(".\\Admin.h", "/Admin.h")
#pragma include_alias(".\\Expo.h", "/Expo.h")
#pragma include_alias(".\\Institute.h", "/Institute.h")
#pragma include_alias(".\\Study.h", "/Study.h")
#pragma include_alias(".\\AdminEAO.h", "/AdminEAO.h")
#pragma include_alias(".\\Stand.h", "/Stand.h")
#pragma include_alias(".\\Visitor.h", "/Visitor.h")
#pragma include_alias(".\\Vote.h", "/Vote.h")
#pragma include_alias(".\\BrowseServlet.h", "/BrowseServlet.h")
#pragma include_alias(".\\ConfirmNewStandServlet.h", "/ConfirmNewStandServlet.h")
#pragma include_alias(".\\ConfirmNewVisitorServlet.h", "/ConfirmNewVisitorServlet.h")
#pragma include_alias(".\\GetQRCodeServlet.h", "/GetQRCodeServlet.h")
#pragma include_alias(".\\NewVisitorServlet.h", "/NewVisitorServlet.h")
#pragma include_alias(".\\QRCodeServlet.h", "/QRCodeServlet.h")
#pragma include_alias(".\\RegistrationClosedServlet.h", "/RegistrationClosedServlet.h")
#pragma include_alias(".\\RegistrationServlet.h", "/RegistrationServlet.h")
#pragma include_alias(".\\ResultServlet.h", "/ResultServlet.h")
#pragma include_alias(".\\StandServlet.h", "/StandServlet.h")
#pragma include_alias(".\\StartServlet.h", "/StartServlet.h")
#pragma include_alias(".\\VerificationServlet.h", "/VerificationServlet.h")
#pragma include_alias(".\\VoteServlet.h", "/VoteServlet.h")
#pragma include_alias(".\\AdminBrowseServlet.h", "/AdminBrowseServlet.h")
#pragma include_alias(".\\AdminEditStandServlet.h", "/AdminEditStandServlet.h")
#pragma include_alias(".\\AdminServlet.h", "/AdminServlet.h")
#pragma include_alias(".\\LogoutServlet.h", "/LogoutServlet.h")
#pragma include_alias(".\\MessageBird.h", "/MessageBird.h")
#pragma include_alias(".\\SMSMock.h", "/SMSMock.h")
#pragma include_alias(".\\InstituteResult.h", "/InstituteResult.h")
#pragma include_alias(".\\Result.h", "/Result.h")
#pragma include_alias(".\\StandResult.h", "/StandResult.h")
#pragma include_alias(".\\StudyResult.h", "/StudyResult.h")
#pragma include_alias(".\\AdminTasks.h", "/AdminTasks.h")
#pragma include_alias(".\\LoginUtils.h", "/LoginUtils.h")
#pragma include_alias(".\\PasswordUtil.h", "/PasswordUtil.h")
#pragma include_alias(".\\QRUtils.h", "/QRUtils.h")
#pragma include_alias(".\\SessionUtils.h", "/SessionUtils.h")
#pragma include_alias(".\\VerificationUtils.h", "/VerificationUtils.h")
#pragma include_alias(".\\VoteUtils.h", "/VoteUtils.h")
#else
...
#include <cassert>
#include "stdio.h"
#define StartServlet_ENUM_BEGIN   namespace StartServlet_ENUM{
#define StartServlet_ENUM_END   }
#define Access   ::StartServlet_ENUM::Access_
#define AdminServlet_ENUM_BEGIN   namespace AdminServlet_ENUM{
#define AdminServlet_ENUM_END   }
#define AdminServlet_ENUM_Access   ::AdminServlet_ENUM::Access_
//------------------------------
//NAMESPACES AND PREDEFINITIONS
//------------------------------
#ifdef __cplusplus
StartServlet_ENUM_BEGIN
StartServlet_ENUM_END
AdminServlet_ENUM_BEGIN
AdminServlet_ENUM_END
#endif 
...
//#define Default 0
//#define IncorrectPassword 1
//#define IncorrectStand 2
//#define RegistrationSMS 3
//#define RegistrationStands 4
//#define RegistrationVotes 5
